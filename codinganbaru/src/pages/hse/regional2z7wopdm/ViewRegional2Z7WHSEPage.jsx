      ...
      <div className="flex">
        ...
        <div className="flex-1 flex flex-col h-screen ml-68 bg-(--background-tar-color) overflow-y-auto px-6 py-3">
          ...
          <main className="flex-1">
            <h1 className="text-2xl font-bold mb-4 mt-2 text-center">Pertamina EP Regional 2 Zona 7 WO PDM HSE View</h1>
...
export default ViewRegional2Z7WHSEPage