...
const StatBoxPertamina2SComponents = ({ onFilterChange, showCategories = ['totemployes', 'duedate', 'call2', 'call1', 'nonactive'], activeFilter = 'totemployes' }) => {
...
export default StatBoxPertamina2SComponents;