...
const FormRegional2Z7WHSEEdit = () => {
  ...
  const fetchEmployeeData = async () => {
    ...
    try {
      const response = await axios.get(`${API_BASE_URL}/regional2Z7W/users/${id}`, {
        headers: {
      ...
      if (response.data) {
        ...
        setFormData({
          ...
          no_telepon: employeeData.no_telepon || '',
...
// Fetch HSE history data
  const fetchHSEHistory = async (userId) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_BASE_URL}/regional2Z7W/users/${userId}/hse-history?t=${timestamp}`,
        {
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
  ...
  const downloadHSEHistory = () => {
    ...
    link.setAttribute('download', `hse-history-${formData.nama_lengkap || id}-Pertamina EP Regional 2 Zona 7 WOPDM.csv`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${API_BASE_URL}/regional2Z7W/users/${id}/hse`,
        formattedData,
        {
          headers: {
            'Content-Type': 'application/json',
      ...
      <div className="flex">
        ...
        <div className="flex-1 flex flex-col h-screen ml-68 bg-(--background-tar-color) overflow-y-auto px-6 py-3">
          ...
          <main className="flex-1">
            <h1 className="text-2xl font-bold mb-4 mt-2 text-center">Edit HSE Data Pertamina EP Regional 2 Zona 7 WOPDM</h1>
            ...
            {loading ? (
              ...
              <div className="mb-6">
                ...
                <div className="flex justify-end mt-6">
                  <Link to="/hse-regional2z7w" className="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-2">
                    Batal
                  </Link>
                  <button 
                    type="submit" 
...
export default FormRegional2Z7WHSEEdit