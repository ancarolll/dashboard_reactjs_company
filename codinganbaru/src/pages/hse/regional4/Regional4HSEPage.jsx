...
const Regional4HSEPage = () => {
    ...
    const fetchDataFromBackend = async () => {
        ...
        try {
        const response = await axios.get(`${API_BASE_URL}/regional4/hse-data`, {
            headers: {
    ...
    const handleEdit = (user) => {
        ...
        navigate(`/hse-regional4-form/${user.id}`, { 
        state: { 
            userData: {...user}
        } 
        });
    ...
    useEffect(() => {
        ...
        navigate('/hse-regional4', { replace: true, state: {} });
        }
    ...
    const mcuColumns = [
        ...
        { name: 'Employee Name', selector: row => row.nama_karyawan || '', sortable: true },
        { name: 'NIK', selector: row => row.nik || '', sortable: true, width: "250px" },
        { name: 'NIK TAR', selector: row => row.nik_tar || '', sortable: true, width: "250px" },
    ...
    const hseColumns = [
        ...
        { name: 'Reason NA', selector: row => row.sebab_na || '', sortable: true, width: "150px" },
        { name: 'Employee Name', selector: row => row.nama_karyawan || '', sortable: true, width: "300px"},
        { name: 'Position', selector: row => row.jabatan || '', sortable: true, width: "300px" },
        { name: 'HSE Passport Number', selector: row => row.no_hsepassport || '', sortable: true, width: "200px" },
    ...
    exportToExcel(mcuFilteredData, 'mcu_data_regional4', 'mcu');
    };
    
    const handleExportHSE = () => {
    exportToExcel(hseFilteredData, 'hse_passport_data_regional4', 'hse');
    };
    
    const handleExportSIM = () => {
    exportToExcel(simlFilteredData, 'sim_data_regional4', 'siml');
    };
    ...
    return (
        ...
        <div className="flex">
            ...
            <main className="flex-1">
                <h1 className="text-2xl font-bold mb-4 mt-2 text-center">Pertamina EP Regional 4 HSE</h1>
...
export default Regional4HSEPage