...
/**
 * View2SBudget Component - Displays Regional 2 Subsurface budget summary data
 * 
...
const View2SBudget = ({ 
  ...
  return (
    <div className="reg2x-budget-container" style={{ padding: embedded ? 0 : '20px' }}>
      {!embedded && (
        <Title level={2}>Regional 2 Subsurface Budget Summary</Title>
      )}
