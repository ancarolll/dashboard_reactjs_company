...
const Regional2Z7WHSEPage = () => {
   ...
   const fetchDataFromBackend = async () => {
       ...
       try {
       const response = await axios.get(`${API_BASE_URL}/regional2Z7W/hse-data`, {
           headers: {
   ...
   const handleEdit = (user) => {
       ...
       navigate(`/hse-regional2z7w-form/${user.id}`, { 
       state: { 
           userData: {...user}
       } 
       });
   ...
   useEffect(() => {
       ...
       navigate('/hse-regional2z7w', { replace: true, state: {} });
       }
...
exportToExcel(mcuFilteredData, 'mcu_data_regional2z7w', 'mcu');
};

const handleExportHSE = () => {
exportToExcel(hseFilteredData, 'hse_passport_data_regional2z7w', 'hse');
};

const handleExportSIM = () => {
exportToExcel(simlFilteredData, 'sim_data_regional2z7w', 'siml');
};
...
return (
  ...
  <div className="flex">
      ...
      <main className="flex-1">
          <h1 className="text-2xl font-bold mb-4 mt-2 text-center">Pertamina EP Regional 2 Zona 7 WOPDM HSE</h1>
...
export default Regional2Z7WHSEPage