...
const StatBoxPertamina4Components = ({ onFilterChange, showCategories = ['totemployes', 'duedate', 'call2', 'call1', 'nonactive'], activeFilter = 'totemployes' }) => {
...
export default StatBoxPertamina4Components;