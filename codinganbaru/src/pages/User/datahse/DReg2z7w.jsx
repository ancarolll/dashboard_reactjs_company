    ...
    <div className='bg-(--background-tar-color)'> 
      <div className="flex">
        ...
        <div className="flex-1 flex flex-col h-screen ml-68 bg-(--background-tar-color) overflow-y-auto px-6 py-3">
          ...
          {/* Back button */}
          <div className="mb-4">
            <Link to='/user-reg2z7w' className="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition">
              &lt; Back
            </Link>
          </div>
          ...
          <main className="flex-1">
            <h1 className="text-2xl font-bold mb-4 mt-2 text-center">Pertamina EP Regional 2 Zona 7 WO PDM HSE </h1>
