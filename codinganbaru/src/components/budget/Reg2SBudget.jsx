...
/**
 * Reg2SBudget Component - Displays and manages Regional 2 Subsurface budget data
 * 
 * @param {Object} props - Component props
 * @param {boolean} props.embedded - Whether component is embedded in another page
 * @param {string} props.apiUrl - API URL base path (defaults to '/api/reg2sbudget')
...
const Reg2SBudget = ({ 
  ...
  try {
    ...
    let filename = 'regional2subsurface_budget_export.xlsx';
  ...
  return (
    <div className="reg2x-budget-container" style={{ padding: embedded ? 0 : '20px' }}>
      {!embedded && (
        <Title level={2}>Regional 2 Subsurface Budget Management</Title>
      )}
              ...
              <>
                ...
                <Card 
                  ...
                  extra={
                    <Space>
                      {/* <Upload {...importProps}>
                        <Button icon={<FontAwesomeIcon icon={faFileImport} />}>Import Excel</Button>
                      </Upload> */}
