...
const FormRegional4HSEEdit = () => {
  ...
  const fetchEmployeeData = async () => {
    ...
    try {
      const response = await axios.get(`${API_BASE_URL}/regional4/users/${id}`, {
        headers: {
      ...
      if (response.data) {
        ...
        setFormData({
          ...
          nik_pep_reg4: employeeData.nik_pep_reg4 || '',
          nik_tar: employeeData.nik_tar || '',
...
// Fetch HSE history data
  const fetchHSEHistory = async (userId) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_BASE_URL}/regional4/users/${userId}/hse-history?t=${timestamp}`,
        {
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
  ...
  const downloadHSEHistory = () => {
    ...
    link.setAttribute('download', `hse-history-${formData.nama_karyawan || id}-Pertamina EP Regional 4.csv`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${API_BASE_URL}/regional4/users/${id}/hse`,
        formattedData,
        {
          headers: {
            'Content-Type': 'application/json',
  ...
  useEffect(() => {
    if (location.state?.userData) {
      ...
      setFormData({
        ...
        nik_pep_reg4: userData.nik_pep_reg4 || '',
        nik_tar: userData.nik_tar || '',
      ...
      <div className="flex">
        ...
        <div className="flex-1 flex flex-col h-screen ml-68 bg-(--background-tar-color) overflow-y-auto px-6 py-3">
          ...
          <main className="flex-1">
            <h1 className="text-2xl font-bold mb-4 mt-2 text-center">Edit HSE Data Pertamina EP Regional 4</h1>
              ...
              <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="mb-6 border-b pb-4">
                  ...
                  <div className="flex justify-end mt-6">
                    <Link to="/hse-regional4" className="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-2">
                      Cancel
                    </Link>
                    <button 
                      type="submit" 
...
export default FormRegional4HSEEdit;