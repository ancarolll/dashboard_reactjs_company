...
const Regional2Z7DHSEPage = () => {
  ...
  const fetchDataFromBackend = async () => {
      ...
      try {
      const response = await axios.get(`${API_BASE_URL}/regional2Z7D/hse-data`, {
          headers: {
...
const applyPrioritySort = (data, dateField) => {
  ...
  const handleEdit = (user) => {
    ...
    navigate(`/hse-regional2z7d-form/${user.id}`, { 
    state: { 
        userData: {...user}
    } 
    });
  ...
  useEffect(() => {
      ...
      navigate('/hse-regional2z7d', { replace: true, state: {} });
      }
...
const handleRowSelected = (state) => setSelectedRows(state.selectedRows);
  ...
  const handleExportMCU = () => {
    exportToExcel(mcuFilteredData, 'mcu_data_regional2z7d', 'mcu');
  };

  const handleExportHSE = () => {
    exportToExcel(hseFilteredData, 'hse_passport_data_regional2z7d', 'hse');
  };

  const handleExportSIM = () => {
    exportToExcel(simlFilteredData, 'sim_data_regional2z7d', 'siml');
  };
  ...
  return (
    ...
    <div className="flex">
        ...
        <main className="flex-1">
            <h1 className="text-2xl font-bold mb-4 mt-2 text-center">Pertamina EP Regional 2 Zona 7 Devplan HSE</h1>
...
export default Regional2Z7DHSEPage