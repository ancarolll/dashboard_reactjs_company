...
import {Table,Button,Form,Input,Select,Modal,message,Popconfirm,Space,Card, Row,Col,Statistic,Divider,Typography,Tabs,InputNumber} from 'antd';
...
/**
 * Reg2XBudget Component - Displays and manages Regional 2 Eksplorasi budget data
 * 
 * @param {Object} props - Component props
 * @param {boolean} props.embedded - Whether component is embedded in another page
 * @param {string} props.apiUrl - API URL base path (defaults to '/api/reg2xbudget')
...
const Reg2XBudget = ({ 
  ...
  try {
    ...
    let filename = 'regional2eksplorasi_budget_export.xlsx';
  ...
  return (
    <div className="reg2x-budget-container" style={{ padding: embedded ? 0 : '20px' }}>
      {!embedded && (
        <Title level={2}>Regional 2 Eksplorasi Budget Management</Title>
      )}
                ...
                >
                    ...
                    <Col xs={24} sm={12} md={6}>
                        ...
                        <Select 
                            ...
                            style={{ width: '100%' }}
                        >
                            {filterOptions.periods && filterOptions.periods.map(period => (
                    ...
                    dataSource={budgetData.absorptions ? budgetData.absorptions.map(item => ({ ...item, key: item.id })) : []} 
                    loading={loading}
      ...
      {/* Master Budget Form Modal */}
        ...
        >
            ...
            label="Remarks"
            >
            <TextArea rows={3} placeholder="Remarks or notes" />
            </Form.Item>
        </Form>
        </Modal>
