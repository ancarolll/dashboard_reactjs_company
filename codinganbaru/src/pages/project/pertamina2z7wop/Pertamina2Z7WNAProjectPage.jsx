...
const PROJECT_ID = 'regional2Z7W';


const Pertamina2Z7WNAProjectPage = () => {
  // State untuk data
...
- The contract end date must be in the future`;
      ...
      try {
        ...
        .then(response => {
          ...
          setTimeout(() => {
            ...
            navigate('/tambah-user-regional2z7w', {
              state: {
                editMode: true,
                userData: userData,
  ...
  const handleExportAllData = () => {
    ...
    exportToExcel(filteredRecords, 'all_inactive_employee_data_pertamina regional 2 zona 7 WOPDM');
  };
  ...
  const handleExportSelectedData = () => {
    ...
    exportToExcel(selectedRows, 'selected_inactive_employee_data_pertamina regional 2 zona 7 WOPDM');
  };
...
const formatWaktuSA = (dateTimeString) => {
  ...
  const columns = [
    ...
    { name: 'Birth Date', selector: row => row.tanggal_lahir, sortable: true, cell: row => formatDate(row.tanggal_lahir),width: "150px" }
  ];
...
export default Pertamina2Z7WNAProjectPage