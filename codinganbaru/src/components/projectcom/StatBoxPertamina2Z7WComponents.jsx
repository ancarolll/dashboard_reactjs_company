...
const StatBoxPertamina2Z7WComponents = ({ onFilterChange, showCategories = ['totemployes', 'duedate', 'call2', 'call1', 'nonactive'], activeFilter = 'totemployes' }) => {
  ...
  const handleNonActiveClick = () => {
    navigate('/nonactive-regional2Z7W');
  };
...
export default StatBoxPertamina2Z7WComponents;