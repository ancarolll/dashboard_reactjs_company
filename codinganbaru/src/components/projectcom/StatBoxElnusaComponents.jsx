...
const StatBoxElnusaComponents = ({ onFilterChange, showCategories = ['totemployes', 'duedate', 'call2', 'call1', 'nonactive'], activeFilter = 'totemployes' }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        let activeResponse;
        try {
          activeResponse = await axios.get(`${API_BASE_URL}/elnusa/users`, {
            headers: {
          ...
          activeResponse = await axios.get(`${API_BASE_URL}/elnusa/edit?format=json`, {
            headers: {
              'Accept': 'application/json'
            },
            timeout: 5000
        ...
        const naResponse = await axios.get(`${API_BASE_URL}/elnusa/na?format=json`, {
          headers: {
            'Accept': 'application/json'
          },
          timeout: 5000
        ...
        console.error('Error retrieving data for StatBox:', err);
...
export default StatBoxElnusaComponents;