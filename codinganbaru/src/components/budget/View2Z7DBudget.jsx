...
/**
 * View2Z7DBudget Component - Displays Regional 2 Z7D budget summary data
 * 
...
const View2Z7DBudget = ({ 
  ...
  return (
    <div className="reg2x-budget-container" style={{ padding: embedded ? 0 : '20px' }}>
      {!embedded && (
        <Title level={2}>Regional 2 Z7D Budget Summary</Title>
      )}
