...
/**
 * View2XBudget Component - Displays Regional 2 Eksplorasi budget summary data
 * 
...
const View2XBudget = ({ 
  ...
  return (
    <div className="reg2x-budget-container" style={{ padding: embedded ? 0 : '20px' }}>
      {!embedded && (
        <Title level={2}>Regional 2 Eksplorasi Budget Summary</Title>
      )}
