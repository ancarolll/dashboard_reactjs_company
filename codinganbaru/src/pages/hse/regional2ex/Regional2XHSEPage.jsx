...
// Di useEffect untuk fetchDataFromBackend
useEffect(() => {
  const fetchData = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/regional2x/hse-data`);
...
const handleEdit = (user) => {
    ...
    navigate(`/hse-regional2x-form/${user.id}`, { 
    state: { 
        userData: {...user}
    } 
    });
...
useEffect(() => {
    ...
    navigate('/hse-regional2x', { replace: true, state: {} });
    }
...
const prepareDataForExport = (data, tableType) => {
    ...
    const formattedData = data.map(item => {
        ...
        if (newItem.tempat_tanggal_lahir) {
            newItem.tempat_tanggal_lahir = newItem.tempat_tanggal_lahir;
        }
        ...
        if (tableType === 'mcu') {
            ...
            return {
                ...
                tempat_tanggal_lahir: newItem.tempat_tanggal_lahir || '',
...
const handleExportMCU = () => {
    exportToExcel(mcuFilteredData, 'mcu_data_regional2x', 'mcu');
};

const handleExportHSE = () => {
    exportToExcel(hseFilteredData, 'hse_passport_data_regional2x', 'hse');
};

const handleExportSIM = () => {
    exportToExcel(simlFilteredData, 'sim_data_regional2x', 'siml');
};
...
export default Regional2XHSEPage