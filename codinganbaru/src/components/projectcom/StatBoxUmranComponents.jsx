...
const StatBoxUmranComponents = ({ onFilterChange, showCategories = ['totemployes', 'duedate', 'call2', 'call1', 'nonactive'], activeFilter = 'totemployes' }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        let activeResponse;
        try {
          activeResponse = await axios.get(`${API_BASE_URL}/umran/users`, {
            headers: {
          ...
          activeResponse = await axios.get(`${API_BASE_URL}/umran/edit?format=json`, {
            headers: {
              'Accept': 'application/json'
            },
            timeout: 5000
        ...
        const naResponse = await axios.get(`${API_BASE_URL}/umran/na?format=json`, {
          headers: {
            'Accept': 'application/json'
          },
          timeout: 5000
...
export default StatBoxUmranComponents;