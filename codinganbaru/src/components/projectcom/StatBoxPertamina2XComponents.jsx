...
const StatBoxPertamina2XComponents = ({ onFilterChange, showCategories = ['totemployes', 'duedate', 'call2', 'call1', 'nonactive'], activeFilter = 'totemployes' }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        let activeResponse;
        try {
          activeResponse = await axios.get(`${API_BASE_URL}/regional2x/users`, {
            headers: {
          ...
          activeResponse = await axios.get(`${API_BASE_URL}/regional2x/edit?format=json`, {
            headers: {
              'Accept': 'application/json'
            },
            timeout: 5000
        ...
        const naResponse = await axios.get(`${API_BASE_URL}/regional2x/na?format=json`, {
          headers: {
            'Accept': 'application/json'
          },
          timeout: 5000
...
export default StatBoxPertamina2XComponents;