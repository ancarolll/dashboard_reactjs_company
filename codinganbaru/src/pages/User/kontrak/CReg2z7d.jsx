...
import { faHouse, faFileContract, faHelmetSafety, faArrowRightFromBracket, faBell, faSun,
  faMagnifyingGlass, faFileAlt  } from '@fortawesome/free-solid-svg-icons';
...
const CReg2z7d = () => {
  ...
  const fetchDataFromBackend = async () => {
    setLoading(true);
    try {
      // Langsung menggunakan endpoint users sebagai alternatif utama seperti di Pertamina2Z7DViewProjectPage
  ...
  // StatBox component (inline version)
  const StatBox = () => {
    ...
    <div className='bg-(--background-tar-color)'> 
      <div className="flex">
        ...
        <div className="flex-1 flex flex-col h-screen ml-68 bg-(--background-tar-color) overflow-y-auto px-6 py-3">
          ...
          {/* Back button */}
          <div className="mb-4">
            <Link to='/user-reg2z7d' className="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition">
              &lt; Back
            </Link>
          </div>
